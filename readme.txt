...
4. 如果打算开启adv模式则进modulemng.config.php手动设置$___MOD_CODE_ADV1、2、3以及$___MOD_SRV这四个参数。不打算开daemon的话，把ADV1设为1即可；想开daemon的请把四个变量全部设为1。之后访问modulemng.php，点击“进入编辑模式”-->“保存”-->“应用更改”，等系统自动处理完毕。
5. 如果开启了daemon模式：
