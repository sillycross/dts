...
if ($_GET['mode']=='edit' || $_GET['action']=='reset')
{
	...
	{
		copy(GAME_ROOT.'./gamedata/modules.list.php',GAME_ROOT.'./gamedata/modules.list.temp.php');
		$res = "<span><font color=\"green b\">成功重置到原先状态。</font></span><br><br>";
	}
}
...
elseif ($_GET['action']=='save')
{
	...
	if ($res === 1)
	{
		echo "<span>没有发现致命错误，请阅读以下日志，如没有问题，请点击“<font color=\"red b\">应用更改</font>”按钮令更改生效。</span><br><br>";
		echo "<span><font color=\"green b\">没有发现问题。</font></span><br><br>";
		...
		echo '<a href="'.$href.'" style="text-decoration: none"><span><font color="red b">[应用更改]</font></span></a>&nbsp;&nbsp;<a href="modulemng.php?mode=edit" style="text-decoration: none"><span><font color="blue b">[返回编辑模式]</font></span></a><br>';   
		copy(GAME_ROOT.'./gamedata/modules.list.php',GAME_ROOT.'./gamedata/modules.list.temp.php');
		die();
	}
	else
...
if($page == 'index') {
	...
	echo '<a href="modulemng.php?mode=edit" style="text-decoration: none"><span><font color="red b">[进入编辑模式]</font></span></a> 添加或修改模块可用性。<br>';
	echo '<a href="modulemng.php?action=save" style="text-decoration: none"><span><font color="green b">[重设代码缓存]</font></span></a> 整体重设模块结构和adv模式代码。<br>';
	echo '<a href="modulemng.php?action=save&mode=quick" style="text-decoration: none"><span><font color="green b">[重设代码缓存（快速）]</font></span></a> 只重设有改动的代码函数。新增模块或函数时切勿使用。<br><br>';  
	//printmodtable(GAME_ROOT.'./gamedata/modules.list.php',1);
	
}elseif($page == 'edit'){
	echo '<br><span><font size=5>模块管理系统<font size=4 color="red b"> 编辑模式</font></font></span><br><br>';
	if(isset($res)) echo $res;
	echo '<a href="modulemng.php?action=reset" style="text-decoration: none"><span><font color="red b">[重置]</font></span></a>&nbsp;&nbsp;
	<a href="modulemng.php?action=save" style="text-decoration: none"><span><font color="green b">[保存]</font></span></a>&nbsp;&nbsp;
	<a href="modulemng.php" style="text-decoration: none"><span><font color="blue b">[返回]</font></span></a><br><br>';
	echo '<font color="green b">添加模块:</font><br>
