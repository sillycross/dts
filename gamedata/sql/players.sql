...
CREATE TABLE bra_players (
  ...
  `wepsk` varchar(255) NOT NULL DEFAULT '',
  ...
  `arbsk` varchar(255) NOT NULL DEFAULT '',
  ...
  `arhsk` varchar(255) NOT NULL DEFAULT '',
  ...
  `arask` varchar(255) NOT NULL DEFAULT '',
  ...
  `arfsk` varchar(255) NOT NULL DEFAULT '',
  ...
  `artsk` varchar(255) NOT NULL DEFAULT '',
  ...
  `itmsk0` varchar(255) NOT NULL DEFAULT '',
  ...
  `itmsk1` varchar(255) NOT NULL DEFAULT '',
  ...
  `itmsk2` varchar(255) NOT NULL DEFAULT '',
  ...
  `itmsk3` varchar(255) NOT NULL DEFAULT '',
  ...
  `itmsk4` varchar(255) NOT NULL DEFAULT '',
  ...
  `itmsk5` varchar(255) NOT NULL DEFAULT '',
  ...
  `itmsk6` varchar(255) NOT NULL DEFAULT '',
