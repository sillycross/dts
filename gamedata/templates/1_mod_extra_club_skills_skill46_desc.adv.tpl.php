...
<?php } else { echo '___aagc'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><td class=b3><span style="margin-top:8px; margin-bottom:8px; display:block;">
<?php } else { echo '___aafU'; } ?><?php $skill46_cnt=(int)\skill46\get_remaintime46(); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="yellow">战斗技</span>&nbsp;&nbsp;<span class="red">限定技&nbsp;本局还可发动<span><?php } else { echo '___aagd'; } ?><?php echo $skill46_cnt?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>/2次</span><br>
本次攻击物理伤害<span class="yellow">+65%</span>，本次战斗中敌方所有称号技能无效<br>
</span></td>
<td class=b3 width=46>
</td>
<?php } else { echo '___aage'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID2'); if(!$___TEMP_THIS_SKILL_ACQUIRED) { ?>
