...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=<?php } else { echo '___aao6'; } ?><?php echo $charset?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>">
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv='expires' content='0'>
<title> ACFUN 大 逃 杀 </title>
<?php } else { echo '___aao7'; } ?><?php if(isset($extrahead)) { ?>
<?php echo $extrahead?>
<?php } ?>
...
<?php } else { echo '___aao8'; } ?><?php global $___MOD_CODE_ADV3; if($___MOD_CODE_ADV3) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><script type="text/javascript" src=
<?php } else { echo '___aao9'; } ?><?php $___TEMP_curdatalibname=file_get_contents(GAME_ROOT.'./gamedata/javascript/datalib.current.txt'); echo '"gamedata/javascript/'.$___TEMP_curdatalibname.'"'; ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>></script>
<?php } else { echo '___aam-'; } ?><?php } ?>
...
<a href="<?php } else { echo '___aapd'; } ?><?php echo $homepage?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" target="_blank">>>官方网站</a>
