...
<?php } else { echo '___aajv'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
<?php } else { echo '___aajw'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID2'); if(!$___TEMP_THIS_SKILL_ACQUIRED) { ?>
