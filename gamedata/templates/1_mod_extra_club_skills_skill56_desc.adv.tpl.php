...
<?php } else { echo '___aafU'; } ?><?php $skill56_cnt=$skill56_lim-(int)\skillbase\skill_getvalue(56,'t'); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="red">限定技&nbsp;本局还可发动<span><?php } else { echo '___aajr'; } ?><?php echo $skill56_cnt?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>/<span><?php } else { echo '___aajs'; } ?><?php echo $skill56_lim?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>次</span><br>    
花费<span class="yellow"><?php } else { echo '___aajt'; } ?><?php echo $skill56_need?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>元，在当前地点随机召唤一名佣兵；<br>
...
<?php } else { echo '___aaju'; } ?><?php \bubblebox\bubblebox_set_style('id:skill56_merc;height:560;width:772;cancellable:1;margin-top:20px;margin-bottom:20px;margin-left:20px;margin-right:10px;'); include template('MOD_BUBBLEBOX_START'); ?>
