...
onclick="$('command').value='<?php } else { echo '___aai7'; } ?><?php echo $w1?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>';$('bskill').value=26;postCmd('gamecmd','command.php');this.disabled=true;"><br />
<div style="width:90%; text-align:left;">
<?php } else { echo '___aai8'; } ?><?php if($sklvl == 1) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>本次攻击伤害全部视为<span class="red">火焰</span>伤害
<?php } else { echo '___aai9'; } ?><?php } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>本次攻击伤害全部视为<span class="red">灼焰</span>伤害
<?php } else { echo '___aai.'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>消耗<span class="red"><?php } else { echo '___aafO'; } ?><?php echo $rageneed?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>怒气
</div>
...
<div style="width:90%; text-align:left;">
需要<span class="red"><?php } else { echo '___aai-'; } ?><?php echo $rageneed?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>怒气方可发动
</div>
