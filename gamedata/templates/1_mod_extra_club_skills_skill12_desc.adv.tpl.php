...
<?php } else { echo '___aag5'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
<?php } else { echo '___aag6'; } ?><?php if($skillpoint >= 1) { ?>
