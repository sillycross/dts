...
<span id="pageinfo">第<span class="yellow" id="startnum"><?php } else { echo '___aakK'; } ?><?php echo $startnum?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>条至第<span class="yellow" id="endnum"><?php } else { echo '___aakL'; } ?><?php echo $endnum?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>条</span>
...
<div id="rank">
<?php } else { echo '___aakM'; } ?><?php include template('rankinfo'); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></div>
</center>
<?php } else { echo '___aakN'; } ?><?php include template('footer'); ?>
