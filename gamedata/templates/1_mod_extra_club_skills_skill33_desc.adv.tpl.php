...
<?php } else { echo '___aaic'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
<tr><td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php } else { echo '___aaii'; } ?><?php if($nchoice==2) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span >
<?php } else { echo '___aaie'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>(2) 无效果 
<?php } else { echo '___aaij'; } ?><?php if($nchoice==2) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>
<?php } else { echo '___aacN'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td><td>
<?php } else { echo '___aaey'; } ?><?php if($nchoice==2) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="lime">[当前选择]</span>
<?php } else { echo '___aaig'; } ?><?php } else { ?>
...
<tr><td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php } else { echo '___aaii'; } ?><?php if($nchoice==3) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span >
<?php } else { echo '___aaie'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>(3) 武器效果视为增加<span class="yellow">0.7x</span>点，防御力降低<span class="yellow">x</span>点  
<?php } else { echo '___aail'; } ?><?php if($nchoice==3) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>
<?php } else { echo '___aacN'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td><td>
<?php } else { echo '___aaey'; } ?><?php if($nchoice==3) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="lime">[当前选择]</span>
<?php } else { echo '___aaig'; } ?><?php } else { ?>
...
<?php } else { echo '___aain'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID2'); if(!$___TEMP_THIS_SKILL_ACQUIRED) { ?>
