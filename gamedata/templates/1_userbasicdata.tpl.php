...
<?php } else { echo '___aasD'; } ?><?php if(CURSCRIPT == 'register') { ?>
...
<?php } else { echo '___aasE'; } ?><?php } elseif(CURSCRIPT == 'user') { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><tr>
<td>账号</td>
<td><?php } else { echo '___aasF'; } ?><?php echo $username?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td> </td>
</tr>
<tr>
<td>原密码</td>
...
<?php } else { echo '___aasG'; } ?><?php } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><tr>
<td>账号</td>
<td><?php } else { echo '___aasF'; } ?><?php echo $username?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td> </td>
