...
<input type="hidden" name="mode" value="enter"> 姓名 : <?php } else { echo '___aar8'; } ?><?php echo $username?><?php if (!defined('GEXIT_RETURN_JSON')) { ?> <br />
<?php } else { echo '___aar9'; } ?><?php include template('usergdicon'); ?>
...
<br />
<?php } else { echo '___aar.'; } ?><?php include template('footer'); ?>
