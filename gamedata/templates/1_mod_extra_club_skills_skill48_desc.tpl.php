<?php if(!defined('IN_GAME')) exit('Access Denied'); eval(import_module('skill48')); $___TEMP_SKILL_ID=48; include template('MOD_CLUBBASE_SKILLDESC_START'); ?>
<span>
附魔
</span>
...
持投系武器方可发动，消耗<span class="yellow"><?php echo $ragecost?></span>点怒气。目前各属性加成统计：<br>
<span style="height:4px; display:block;">&nbsp;</span>
<?php \skill48\get_status_html48(); ?>
</span></td>
