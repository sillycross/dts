...
<br>
<?php } else { echo '___aap0'; } ?><?php if(is_array(Array(6,5,1,9,88))) { foreach(Array(6,5,1,9,88) as $key) { \npcinfo\npcinfo_get_npc_description_all($key); } } ?>
...
<br>
<?php } else { echo '___aap1'; } ?><?php if(is_array(Array(11))) { foreach(Array(11) as $key) { \npcinfo\npcinfo_get_npc_description_all($key); } } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><br>
...
<br>
<?php } else { echo '___aap2'; } ?><?php if(is_array(Array(2,90))) { foreach(Array(2,90) as $key) { \npcinfo\npcinfo_get_npc_description_all($key); } } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><br>
...
<br>
<?php } else { echo '___aap3'; } ?><?php if(is_array(Array(14))) { foreach(Array(14) as $key) { \npcinfo\npcinfo_get_npc_description_all($key); } } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><br>
...
<br>
<?php } else { echo '___aap4'; } ?><?php \bubblebox\bubblebox_set_style('id:yl_npc;height:560;width:772;cancellable:1;margin-top:20px;margin-bottom:20px;margin-left:20px;margin-right:10px;'); include template('MOD_BUBBLEBOX_START'); ?>
...
<br>
<?php } else { echo '___aap5'; } ?><?php if(is_array(Array(22))) { foreach(Array(22) as $key) { \npcinfo\npcinfo_get_npc_description_all($key); } } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><br>
...
<br>
<?php } else { echo '___aap6'; } ?><?php if(is_array(Array(21))) { foreach(Array(21) as $key) { \npcinfo\npcinfo_get_npc_description_all($key); } } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><br> 
<?php } else { echo '___aap7'; } ?><?php include template('MOD_BUBBLEBOX_END'); ?>
