...
<?php } else { echo '___aad5'; } ?><?php if((!defined('MOD_CLUBBASE'))) { if((defined('MOD_WEAPON'))) { include template('MOD_WEAPON_ATT_METHOD'); } ?>
...
<?php } else { echo '___aad6'; } ?><?php } else { ?>
...
<?php } else { echo '___aad7'; } ?><?php if((defined('MOD_WEAPON'))) { include template('MOD_WEAPON_ATT_METHOD'); } \clubbase\get_battle_skill_entry(3); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><br><input type="button" class="cmdbutton" name="back" value="逃跑" onclick="postCmd('gamecmd','command.php');this.disabled=true;"> 
</td>
<td width=100px align="center" style="vertical-align:top">
<?php } else { echo '___aad8'; } ?><?php \clubbase\get_battle_skill_entry(1); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td width=100px align="center" style="vertical-align:top">
<?php } else { echo '___aad9'; } ?><?php \clubbase\get_battle_skill_entry(2); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
</tr></table>
