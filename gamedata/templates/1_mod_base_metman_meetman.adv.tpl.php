...
<tr>
<td class="b1" colspan=2 height=20px><span>Lv. <?php } else { echo '___aacp'; } ?><?php echo $tdata['lvl']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>                                            
<td class="b1" colspan=2><span><?php } else { echo '___aacq'; } ?><?php echo $tdata['name']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>                                            
<td class="b1" colspan=2><span><?php } else { echo '___aacq'; } ?><?php echo $tdata['sNoinfo']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>                                            
<td class="b5" rowspan=4 width=140px colspan=1 height=80px><IMG src="img/<?php } else { echo '___aacr'; } ?><?php echo $tdata['iconImg']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" height=80px border="0" align="middle" 
<?php } else { echo '___aacs'; } ?><?php if($w_hp==0) { ?>
...
<td class="b3" width=90px><span><?php } else { echo '___aacu'; } ?><?php echo $tdata['ragestate']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
<td class="b2" width=75px><span>体力</span></td>
<td class="b3" width=90px><span><?php } else { echo '___aacv'; } ?><?php echo $tdata['spstate']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
<td class="b2" width=100px><span>生命</span></td>
<td class="b3" width=145px><span><?php } else { echo '___aacw'; } ?><?php echo $tdata['hpstate']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
</tr>
<tr>
<td class="b2" height=20px><span>武器攻击</span></td>
<td class="b3"><span><?php } else { echo '___aacx'; } ?><?php echo $tdata['wepestate']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
<td class="b2"><span>武器种类</span></td>
<td class="b3"><span>
<?php } else { echo '___aacy'; } ?><?php if((isset($iteminfo[$tdata['wepk']]))) { ?>
...
<td class="b3"><span><?php } else { echo '___aacz'; } ?><?php echo $tdata['wep']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
</tr>
<tr>
<?php } else { echo '___aacA'; } ?><?php if(defined('MOD_TACTIC')) { include template('MOD_TACTIC_ENEMY_TACTIC'); } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><td class="b2"><span></span></td><td class="b3"><span></span></td>
<?php } else { echo '___aacB'; } ?><?php } if(defined('MOD_POSE')) { include template('MOD_POSE_ENEMY_POSE'); } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><td class="b2"><span></span></td><td class="b3"><span></span></td>
<?php } else { echo '___aacB'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><td class="b2"><span>受伤部位</span></td>
<td class="b3"><span>
<?php } else { echo '___aacC'; } ?><?php if($tdata['infdata']) { ?>
...
<span><B><FONT color="#ff0000" size="5" face="黑体"><?php } else { echo '___aacD'; } ?><?php echo $battle_title?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></FONT></B></span>
</TD>
</TR>
<tr>
<td>
...
<tr>
<td class="b5" rowspan=4 colspan=1 width=140px height=80px><IMG src="img/<?php } else { echo '___aacE'; } ?><?php echo $iconImg?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" height=80px border="0" align="middle" 
<?php } else { echo '___aacs'; } ?><?php if($hp==0) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>style="filter:Xray()"
<?php } else { echo '___aact'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?> /></td>
<td class="b1" colspan=2 height=20px><span><?php } else { echo '___aacF'; } ?><?php echo $typeinfo[$type]?>(<?php echo $sexinfo[$gd]?><?php echo $sNo?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>号)</span></td>
<td class="b1" colspan=2><span><?php } else { echo '___aacG'; } ?><?php echo $name?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
<td class="b1" colspan=2><span>Lv. <?php } else { echo '___aacH'; } ?><?php echo $lvl?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
</tr>
<tr>
<td class="b2" width=100px height=20px><span>生命</span></td>
<td class="b3" width=145px><span><span class="<?php } else { echo '___aacI'; } ?><?php echo $hpcolor?>"><?php echo $hp?><?php if (!defined('GEXIT_RETURN_JSON')) { ?> / <?php } else { echo '___aacJ'; } ?><?php echo $mhp?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></span></td>
<td class="b2" width=75px><span>体力</span></td>
<td class="b3" width=90px><span><?php } else { echo '___aacK'; } ?><?php echo $sp?><?php if (!defined('GEXIT_RETURN_JSON')) { ?> / <?php } else { echo '___aacJ'; } ?><?php echo $msp?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
<td class="b2" width=75px><span>怒气</span></td>
<td class="b3" width=90px><span>
<?php } else { echo '___aacL'; } ?><?php if($rage >=30) { ?>
...
<td class="b3"><span><?php } else { echo '___aacO'; } ?><?php echo $wep?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
<td class="b2"><span>武器种类</span></td>
<td class="b3"><span><?php } else { echo '___aacP'; } ?><?php echo $iteminfo[$wepk]?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
<td class="b2"><span>武器攻击</span></td>
<td class="b3"><span><?php } else { echo '___aacQ'; } ?><?php echo $wepe?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
</tr>
<tr>
<td class="b2" height=20px><span>受伤部位</span></td>
<td class="b3">
<span>
<?php } else { echo '___aacR'; } ?><?php if($inf) { if(is_array($infinfo)) { foreach($infinfo as $key => $val) { if(strpos($inf,$key)!==false) { ?>
<?php echo $val?>
<?php } } } } else { ?>
无
<?php } ?>
...
<?php } else { echo '___aacS'; } ?><?php if(defined('MOD_POSE')) { include template('MOD_POSE_POSE_PROFILE'); } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><td class="b2"><span></span></td><td class="b3"><span></span></td>
<?php } else { echo '___aacB'; } ?><?php } if(defined('MOD_TACTIC')) { include template('MOD_TACTIC_TACTIC_PROFILE'); } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><td class="b2"><span></span></td><td class="b3"><span></span></td>
<?php } else { echo '___aacB'; } ?><?php } ?>
