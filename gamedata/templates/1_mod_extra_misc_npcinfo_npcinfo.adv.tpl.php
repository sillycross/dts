...
<tr>
<td>
<IMG width=140px src="img/n_<?php } else { echo '___aaiw'; } ?><?php echo $nownpc['icon']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>.gif" border="0" valign="middle"/>
</td>
<td>
...
<?php } else { echo '___aaix'; } ?><?php echo $typeinfo[$npckind]?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td width=100px align="center" class="b1">
数目
</td>
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiy'; } ?><?php echo $nownpc['___count']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td width=100px align="center" class="b1">
所处地点
</td>
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiz'; } ?><?php if($nownpc['pls']==99) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>随机
<?php } else { echo '___aaiA'; } ?><?php } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="yellow">
<?php } else { echo '___aagb'; } ?><?php echo $plsinfo[$nownpc['pls']]?>
...
<td width=100px align="center" class="b3">
<span>
Lv. <?php } else { echo '___aaiB'; } ?><?php echo $nownpc['lvl']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>
</td>
<td width=100px align="center" class="b1">
NPC名称
...
<td width=100px align="center" class="b3">
<span class="lime">
<?php } else { echo '___aaiC'; } ?><?php echo $nownpc['name']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>
</td>
<td width=100px align="center" class="b1">
性别
...
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiD'; } ?><?php if($nownpc['gd']=='m') { ?>
男
<?php } else { if($nownpc['gd']=='f') { ?>
女
<?php } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>随机
<?php } else { echo '___aaiA'; } ?><?php } } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
</tr>                    
<tr>
<td width=100px align="center" class="b1">
...
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiE'; } ?><?php if(isset($nownpc['club'])) { ?>
...
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiF'; } ?><?php echo $poseinfo[$nownpc['pose']]?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td width=100px align="center" class="b1">
应战策略
</td>
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiG'; } ?><?php echo $tacinfo[$nownpc['tactic']]?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
</tr>
<tr>
<td width=100px align="center" class="b1">
...
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiH'; } ?><?php echo $nownpc['mhp']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td width=100px align="center" class="b1">
熟练度
</td>
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiI'; } ?><?php echo $nownpc['skill']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td width=100px align="center" class="b1">
怒气值
</td>
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiJ'; } ?><?php echo $nownpc['rage']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
</tr>
<tr>
<td width=100px align="center" class="b1">
...
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiK'; } ?><?php echo $nownpc['att']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td width=100px align="center" class="b1">
基础防御
</td>
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiL'; } ?><?php echo $nownpc['def']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td width=100px align="center" class="b1">
掉落金钱
</td>
<td width=100px align="center" class="b3">
<?php } else { echo '___aaiM'; } ?><?php echo $nownpc['money']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
</tr>
</table>
</td>
...
<tr>
<td width=140px>
<?php } else { echo '___aaiN'; } ?><?php echo $nownpc['description']?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
<td>
<table border="1" cellspacing="0" cellpadding="0" valign="middle">
<tr>
...
<?php } else { echo '___aaiU'; } ?><?php if(is_array(Array(1,2,3,4,5,6))) { foreach(Array(1,2,3,4,5,6) as $id) { if($nownpc['itm'.$id]!='') { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><tr>
<td width=100px align="center" class="b1">
掉落物品
</td>
<td width=505px align="center" class="b3">
<?php } else { echo '___aaiV'; } ?><?php \npcinfo\npcinfo_gen_item_description($nownpc['itm'.$id],$nownpc['itmk'.$id],$nownpc['itme'.$id],$nownpc['itms'.$id],$nownpc['itmsk'.$id]); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td>
</tr>
<?php } else { echo '___aaiU'; } ?><?php } } } ?>
