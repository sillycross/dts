...
<?php } else { echo '___aahW'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
持投系武器方可发动，消耗<span class="yellow"><?php } else { echo '___aahX'; } ?><?php echo $ragecost?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>点怒气。目前各属性加成统计：<br>
<span style="height:4px; display:block;">&nbsp;</span>
<?php } else { echo '___aahY'; } ?><?php \skill48\get_status_html48(); ?>
...
<?php } else { echo '___aah0'; } ?><?php } include template('MOD_CLUBBASE_SKILLDESC_END'); ?>
