...
<td class="b3"><span>
<?php } else { echo '___aaey'; } ?><?php if($club!=0) { ?>
...
<?php } else { echo '___aaez'; } ?><?php if(CURSCRIPT != 'game' || $mode != 'command') { ?>
...
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="clubsel<?php } else { echo '___aaeA'; } ?><?php echo $key?>"
<?php if($club == $key) { ?>
