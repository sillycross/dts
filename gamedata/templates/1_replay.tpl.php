...
<?php } else { echo '___aamP'; } ?><?php echo '"gamedata/javascript/'.$repdatalib.'"';; ?>
...
<img src="<?php } else { echo '___aamQ'; } ?><?php echo $repbg?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" style="width:1000px;z-index:10000;filter:alpha(opacity=40); opacity:0.4;"/>
<img src="<?php } else { echo '___aamR'; } ?><?php echo $repbg?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" style="width:1000px;z-index:10000;filter:alpha(opacity=80); opacity:0.8;"/>
<img id="replay_bar_core" src="<?php } else { echo '___aamS'; } ?><?php echo $repbg?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" style="width:1000px;z-index:10000;"/>
<img src="<?php } else { echo '___aamT'; } ?><?php echo $repbg?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" style="width:1000px;z-index:10000;filter:alpha(opacity=80); opacity:0.8;"/>
<img src="<?php } else { echo '___aamU'; } ?><?php echo $repbg?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" style="width:1000px;z-index:10000;filter:alpha(opacity=40); opacity:0.4;"/>
</div>
<!-- 主轴 END -->
...
<!-- 录像载入进度气泡框 START -->
<?php } else { echo '___aamV'; } ?><?php \bubblebox\bubblebox_set_style('id:replayhint;height:200;width:500;cancellable:0;margin-right:8px;'); include template('MOD_BUBBLEBOX_START'); ?>
...
<table>
<tr><td width=200px>
玩家: <span class="lime"><?php } else { echo '___aamW'; } ?><?php echo $repname?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>
</td><td width=200px>
游戏局号: <?php } else { echo '___aamX'; } ?><?php echo $repgnum?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td></tr>
<tr><td width=200px>
录像文件大小: <?php } else { echo '___aamY'; } ?><?php echo $repsz?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></td><td width=200px>
操作总数: <?php } else { echo '___aamZ'; } ?><?php echo $repopcnt?><?php if (!defined('GEXIT_RETURN_JSON')) { ?> 
</td></tr>
</table>

</td></tr></table>
<?php } else { echo '___aam0'; } ?><?php include template('MOD_BUBBLEBOX_END'); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><script type="text/javascript">bubblebox_show('replayhint');</script>
<!-- 录像载入进度气泡框 END -->

<!-- 播放结束气泡框 START -->
<?php } else { echo '___aam1'; } ?><?php \bubblebox\bubblebox_set_style('id:persistent-replay-endhint;height:200;width:500;cancellable:1;margin-right:8px;'); include template('MOD_BUBBLEBOX_START'); ?>
...
<?php } else { echo '___aam2'; } ?><?php include template('MOD_BUBBLEBOX_END'); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><!-- 播放结束气泡框 END -->

<!-- 载入录像 -->
<script type="text/javascript" src=
<?php } else { echo '___aam3'; } ?><?php echo '"gamedata/replays/'.$repid.'.replay.header.js"'; ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?>></script>
<?php } else { echo '___aam4'; } ?><?php include template('game_interface'); include template('footer'); ?>
