...
<?php } else { echo '___aag2'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
<?php } else { echo '___aag3'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID2'); if(!$___TEMP_THIS_SKILL_ACQUIRED) { ?>
