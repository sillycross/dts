<?php if(!defined('IN_GAME')) exit('Access Denied'); eval(import_module('skill56')); $___TEMP_SKILL_ID=56; include template('MOD_CLUBBASE_SKILLDESC_START'); ?>
<span>
保镖
</span>
<?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
<td class=b3><span style="margin-top:8px; margin-bottom:8px; display:block;">
<?php $skill56_cnt=$skill56_lim-(int)\skillbase\skill_getvalue(56,'t'); ?>
<span class="red">限定技&nbsp;本局还可发动<span><?php echo $skill56_cnt?></span>/<span><?php echo $skill56_lim?></span>次</span><br>	
花费<span class="yellow"><?php echo $skill56_need?></span>元，在当前地点随机召唤一名佣兵；<br>
...
<?php \bubblebox\bubblebox_set_style('id:skill56_merc;height:560;width:772;cancellable:1;margin-top:20px;margin-bottom:20px;margin-left:20px;margin-right:10px;'); include template('MOD_BUBBLEBOX_START'); ?>
