...
<?php } else { echo '___aaaV'; } ?><?php if($itms1) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="1">包裹1：<?php } else { echo '___aaaW'; } ?><?php echo $itm1?>/<?php echo $itme1?>/<?php echo $itms1?><?php if (!defined('GEXIT_RETURN_JSON')) { ?><br />
<?php } else { echo '___aaaX'; } ?><?php } if($itms2) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="2">包裹2：<?php } else { echo '___aaaY'; } ?><?php echo $itm2?>/<?php echo $itme2?>/<?php echo $itms2?><?php if (!defined('GEXIT_RETURN_JSON')) { ?><br />
<?php } else { echo '___aaaX'; } ?><?php } if($itms3) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="3">包裹3：<?php } else { echo '___aaaZ'; } ?><?php echo $itm3?>/<?php echo $itme3?>/<?php echo $itms3?><?php if (!defined('GEXIT_RETURN_JSON')) { ?><br />
<?php } else { echo '___aaaX'; } ?><?php } if($itms4) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="4">包裹4：<?php } else { echo '___aaa0'; } ?><?php echo $itm4?>/<?php echo $itme4?>/<?php echo $itms4?><?php if (!defined('GEXIT_RETURN_JSON')) { ?><br />
<?php } else { echo '___aaaX'; } ?><?php } if($itms5) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="5">包裹5：<?php } else { echo '___aaa1'; } ?><?php echo $itm5?>/<?php echo $itme5?>/<?php echo $itms5?><?php if (!defined('GEXIT_RETURN_JSON')) { ?><br />
<?php } else { echo '___aaaX'; } ?><?php } if($itms6) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="6">包裹6：<?php } else { echo '___aaa2'; } ?><?php echo $itm6?>/<?php echo $itme6?>/<?php echo $itms6?><?php if (!defined('GEXIT_RETURN_JSON')) { ?><br />
...
<?php } else { echo '___aaa3'; } ?><?php if($itms1) { ?>
...
<?php } else { echo '___aaa5'; } ?><?php } if($itms3) { ?>
...
<?php } else { echo '___aaa6'; } ?><?php } if($itms4) { ?>
...
<?php } else { echo '___aaa7'; } ?><?php } if($itms5) { ?>
...
<?php } else { echo '___aaa8'; } ?><?php } if($itms6) { ?>
...
<?php } else { echo '___aaa9'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></select>
<br><br>
<input type="button" class="cmdbutton" name="submit" value="提交" onclick="$('from').value=$('merge1').value;$('to').value=$('merge2').value;postCmd('gamecmd','command.php');this.disabled=true;"><?php } else { echo '___aaa.'; } ?>