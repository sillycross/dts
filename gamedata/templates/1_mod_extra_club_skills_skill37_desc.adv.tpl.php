...
<?php } else { echo '___aag-'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
<?php } else { echo '___aaha'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID2'); if(!$___TEMP_THIS_SKILL_ACQUIRED) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="yellow">
6级时解锁
</span>
<?php } else { echo '___aahb'; } ?><?php } include template('MOD_CLUBBASE_SKILLDESC_END'); ?>
