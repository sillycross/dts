...
<input type="radio" name="command" id="shop3" value="shop3"><a onclick=sl('shop3'); href="javascript:void(0);" onmouseover="status=' ';return true;">【<?php } else { echo '___aada'; } ?><?php echo $iteminfo['WP']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>】</a><br>
<input type="radio" name="command" id="shop4" value="shop4"><a onclick=sl('shop4'); href="javascript:void(0);" onmouseover="status=' ';return true;">【<?php } else { echo '___aadb'; } ?><?php echo $iteminfo['WK']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>】</a><br>
<input type="radio" name="command" id="shop5" value="shop5"><a onclick=sl('shop5'); href="javascript:void(0);" onmouseover="status=' ';return true;">【<?php } else { echo '___aadc'; } ?><?php echo $iteminfo['WG']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>】</a><br>
<input type="radio" name="command" id="shop6" value="shop6"><a onclick=sl('shop6'); href="javascript:void(0);" onmouseover="status=' ';return true;">【<?php } else { echo '___aadd'; } ?><?php echo $iteminfo['WC']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>】</a><br>
<input type="radio" name="command" id="shop7" value="shop7"><a onclick=sl('shop7'); href="javascript:void(0);" onmouseover="status=' ';return true;">【<?php } else { echo '___aade'; } ?><?php echo $iteminfo['WD']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>】</a><br>
<input type="radio" name="command" id="shop8" value="shop8"><a onclick=sl('shop8'); href="javascript:void(0);" onmouseover="status=' ';return true;">【<?php } else { echo '___aadf'; } ?><?php echo $iteminfo['WF']?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>材料】</a><br>
...
<br><br>
<input type="button" class="cmdbutton" name="submit" value="提交" onclick="postCmd('gamecmd','command.php');this.disabled=true;"><?php } else { echo '___aadg'; } ?>