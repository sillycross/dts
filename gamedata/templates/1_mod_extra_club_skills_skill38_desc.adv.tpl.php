...
<?php } else { echo '___aahb'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
持殴系武器方可发动，发动消耗<span class="yellow"><?php } else { echo '___aahc'; } ?><?php echo $ragecost?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>点怒气。<br>
</span></td>
