...
<?php } else { echo '___aahy'; } ?><?php if(CURSCRIPT != 'game' || $mode != 'command') { ?>
...
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="pose<?php } else { echo '___aahz'; } ?><?php echo $key?>"
<?php if($pose == $key) { ?>
