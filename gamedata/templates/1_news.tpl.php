...
<br>
<?php } else { echo '___aaoV'; } ?><?php eval(import_module('weather')); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="evergreen">当前时间：<?php } else { echo '___aaoW'; } ?><?php echo $month?>月<?php echo $day?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>日 星期<?php } else { echo '___aanc'; } ?><?php echo $week["$wday"]?> <?php echo $hour?>:<?php echo $min?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span><br />
<span class="evergreen">当前天气：<?php } else { echo '___aaoX'; } ?><?php echo $wthinfo[$weather]?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span><br />
<?php } else { echo '___aaoY'; } ?><?php if($gamestate==40) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="yellow">游戏已经进入连斗阶段！</span><br />
<?php } else { echo '___aaoZ'; } ?><?php } if($gamestate==50) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="red">游戏已经进入死斗模式！</span><br />
<?php } else { echo '___aao0'; } ?><?php } if($hack) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="evergreen">（禁区已解除）</span>
<?php } else { echo '___aao1'; } ?><?php } include template('areainfo'); ?>
...
<button onClick="$('newsmode').value='last';postCmd('news','news.php');">显示最新的<?php } else { echo '___aao2'; } ?><?php echo $newslimit?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>条消息</button>
...
<div id="newsinfo">
<?php } else { echo '___aao3'; } ?><?php if($newsmode == 'all') { include template('newsinfo'); } else { include template('lastnews'); } ?>
...
<?php } else { echo '___aao4'; } ?><?php include template('footer'); ?>
