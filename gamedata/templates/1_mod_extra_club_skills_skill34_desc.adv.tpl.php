...
<?php } else { echo '___aaiQ'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
<?php } else { echo '___aaiR'; } ?><?php if($nchoice!='') { ?>
...
<?php } else { echo '___aaiS'; } ?><?php if($nchoice=='') { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="" selected>无<br />
<?php } else { echo '___aaiT'; } ?><?php } if(is_array(\skill34\get_avaliable_attr())) { foreach(\skill34\get_avaliable_attr() as $key) { if($key!=$nchoice) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="<?php } else { echo '___aaiU'; } ?><?php echo $key?>"><?php echo $itemspkinfo[$key]?><?php if (!defined('GEXIT_RETURN_JSON')) { ?><br />
<?php } else { echo '___aaaX'; } ?><?php } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><option value="<?php } else { echo '___aaiU'; } ?><?php echo $key?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>" selected><?php } else { echo '___aaiV'; } ?><?php echo $itemspkinfo[$key]?><?php if (!defined('GEXIT_RETURN_JSON')) { ?><br />
...
<?php } else { echo '___aaiW'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID2'); if(!$___TEMP_THIS_SKILL_ACQUIRED) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="yellow">
在“格挡”和“猛击”上共计花费至少15技能点以解锁<br>
<?php } else { echo '___aaiX'; } ?><?php $skill34_cprogress=\skill34\get_unlock34_progress($sdata); if($skill34_cprogress>0) { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="clan">当前进度<?php } else { echo '___aaiY'; } ?><?php echo $skill34_cprogress?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>/15</span>
<?php } else { echo '___aaiZ'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>
