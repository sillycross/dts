...
<td class="b2"><span>
<?php } else { echo '___aaeY'; } ?><?php if(($$key >= 100)) { ?>
<?php echo $value?>熟
<?php } else { ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?><span class="grey">
<?php } else { echo '___aaeZ'; } ?><?php echo $value?><?php if (!defined('GEXIT_RETURN_JSON')) { ?>熟</span>
<?php } else { echo '___aae0'; } ?><?php } ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
<td class="b3"><span>
<?php } else { echo '___aae1'; } ?><?php eval('echo $'.$key.';'); ?>
<?php if (!defined('GEXIT_RETURN_JSON')) { ?></span></td>
</tr>
<?php } else { echo '___aae2'; } ?><?php } } } ?>
