...
<?php } else { echo '___aafI'; } ?><?php include template('MOD_CLUBBASE_SKILLDESC_MID1'); ?>
...
发动消耗<span class="yellow"><?php } else { echo '___aafJ'; } ?><?php echo $ragecost?><?php if (!defined('GEXIT_RETURN_JSON')) { ?></span>点怒气。<br>
</span></td>
