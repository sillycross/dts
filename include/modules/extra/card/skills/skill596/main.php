...
namespace skill596
{
	$skill596_prefix = array('揭秘！','震惊！','爆料！','曝光！','深度解析！','必看！','再不看就迟了！','威胁！','神秘！','恐怖！','惊愕！','疑惑！','禁忌！','逆转！','当心！','复杂！','悲情！','欢乐！');
	$skill596_suffix = array(
		...
		array('竟有如此危害？','内幕曝光令人震惊！','让你的生活更加美好！','令人反思！','你绝对不容错过！','竟然能合成神器！','让你一夜暴富！','正在成为新时尚！','竟让他们大打出手！','大家都在用！','今天半价！','竟成为关键证据！','你还在这样使用吗？','原理受多位贤者热议！')
	);
