...
namespace skill449
{
	function init() 
	{
		define('MOD_SKILL449_INFO','club;unique;locked;');
	...
	function get_final_dmg_multiplier(&$pa, &$pd, $active)
	{
		...
		if ((\skillbase\skill_query(449,$pa))&&(check_unlocked449($pa)))
		{
			...
			if ($pd['type']==90){
				if ($active)
					$log.="<span class=\"yellow\">你对小兵的仇恨使你造成的最终伤害提高了15%！</span><br>";
				else  $log.="<span class=\"yellow\">敌人对小兵的仇恨使其造成的最终伤害提高了15%！</span><br>";
				$r=Array(1.15);
			}
		}
