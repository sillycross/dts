...
<br>￣^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^￣
	...
	391 => array(
		...
		'valid' => array(
			...
			'itme6' => '1',
			'itms6' => '1',
			'itmsk6' => array('^res_<:comp_itmsk:>{棕色的Howling玩偶.A.1.1.N.}1^rtype4^reptype1', '^res_<:comp_itmsk:>{深蓝色的S.A.S玩偶.A.1.1.n.}1^rtype4^reptype1', '^res_<:comp_itmsk:>{天青色的Annabelle玩偶.A.1.1.i.}1^rtype4^reptype1', '^res_<:comp_itmsk:>{红色的星海玩偶.A.1.1.M.}1^rtype4^reptype1', '^res_<:comp_itmsk:>{粉色的Sophia玩偶.A.1.1.w.}1^rtype4^reptype1'),
		),
	),
	392 => array(
		'name' => '「恶魔之盒」',
		'rare' => 'B',
		'pack' => 'Ranmen',
		'desc' => '某天早晨你醒来的时候，看到床头多了一个盒子，上面写着：',
		'effect' => '把钱放进去有一半概率翻倍，也有一半概率消失',
	...
	394 => array(
		...
		'pack' => 'Ranmen',
		'desc' => '看好了，骰子是这样用的',
		'effect' => '开局获得一个只有自己能使用的骰子，使用后可以将自己的所有技能替换为随机技能',
