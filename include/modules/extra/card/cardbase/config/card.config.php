...
<br>￣^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^Ｙ^￣
	...
	369 => array(
		...
		'desc_skills' => '通常合成时，你可以将一个素材当做仅相差一个字符的素材使用<br>同一次合成中仅限一个素材，开局15分钟或15级时解锁',
		'energy' => 100,
		'valid' => array(
			'skills' => array(
				'708' => '0',
	...
	380 => array(
		...
		'desc' => '他从地狱中归来',
		'effect' => '获得技能「炼狱」',
		'desc_skills' => '「炼狱」：每次发动后使自己先制率-1.5%，命中率、闪避率、发现率、造成伤害-5%（可叠加）。若上一次发动后击杀了15个敌人，则将所有减益变为等量的增益，然后不再能发动此技能',
		'energy' => 0,
		'valid' => array(
			'skills' => array(
				'719' => '0',
