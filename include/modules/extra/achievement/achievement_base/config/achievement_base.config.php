...
namespace achievement_base{
	...
	$ach_allow_mode=array(
		0 => array(0, 4, 6, 10, 14, 15, 16, 18, 19),//默认标准、自选、随机、SOLO、组队、伐木、解离、荣耀、极速都可以完成
		...
		308 => array(0, 4, 6, 10, 15, 18, 19),//KEY弹竞速成就，SOLO和伐木也能完成。组队房、解离房都能合作加速，因此不能完成
		309 => array(0, 4, 6, 10, 15, 18, 19),//贤者竞速成就，同上
		...
		322 => array(0, 4, 6, 10, 14, 18),//30分钟死斗成就，只允许标准、卡片、随机卡片、SOLO、组队和荣耀模式完成
		...
		344 => array(0, 4, 6, 10, 14, 18, 19),//日常使用KEY弹杀死1名活跃玩家，可以在PVP房完成
		345 => array(0, 4, 6, 10, 14, 18, 19),//日常使用小黄杀死1名活跃玩家，可以在PVP房完成
		...
		349 => array(0, 4, 6, 10, 14, 18),//危险地区杀玩家成就，可以在PVP房完成，但是极速因为没有SCP所以不行
