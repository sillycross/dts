...
namespace item_slip
{
	...
	$item_slip_hint = Array(
		...
		'B' => '“所有玩家都在囚徒困境中。你最大的敌人不是红暮他们，而是其他玩家。<br>“我会为救出所有人而战，但对你而言，面对那些攻击同伴的玩家，<span class="yellow b">不择手段地活下去，是最重要的任务</span>。<br>“如果有余力，再想办法挑战红暮和她的爪牙们吧。”',
		...
		'D' => '“我还在这个世界里安置了一个「病毒」。<br>“病毒的触发器以<span class="yellow b">「歌词卡片」</span>作为伪装，藏在三名<span class="yellow b">「数据碎片」</span>身上。<br>这些「数据碎片」的<span class="red b">真正战斗力</span>十分不俗，足以抵抗幻境的自我防御机制，但也让获取触发器变得十分困难。我估计，<span class="yellow b">生命超过900、防御力超过3000</span>并且拥有<span class="yellow b">属性防御</span>的装备<span class="yellow b">和</span>技能，才勉强有资格挑战最无厘头的那位吧……<br>“把三个触发器合并到一起，就能激活病毒。那时，受到病毒感染的幻境代码核心<span class="yellow b">将在这个世界现身</span>。她的战斗力很强，但是并不是无敌的。击倒她获得<span class="yellow b">「十字发卡」</span>之后……<br>“呃，地方写不下了。”',
