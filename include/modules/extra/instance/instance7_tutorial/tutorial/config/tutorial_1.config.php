...
//	),
	...
	100 => Array(
		'tips' => '“【泡面】吗，诶……为什么这个地方会有泡面？看起来有点可疑。把它<span class="yellow b">捡起来</span>吧。”<br>',
		'object' => 'itemget',
		'obj2' => Array(
			'itm' => '泡面',
			'itmk' => 'PB',
	...
	110 => Array(
		'tips' => '“食物一般属于【回复道具】，比如这个泡面就是<span class="yellow b">【命体回复】</span>道具，使用后可以吃掉它来同时回复生命值和体力值。点击道具名左边的<span class="yellow b">【使用】</span>按钮来使用它吧。”<br>',
		'object' => 'itemuse',
		'obj2' => Array(
			'itm' => '泡面'
		),
	...
	120 => Array(
		'tips' => '“哎呀，果然有毒……对不起，我笑场了，是我干的。<br>探索获得的【回复道具】中，有一部分可能<span class="purple b">【有毒】</span>，胡乱吃下的话，就会倒扣生命值，并且<span class="purple b">【中毒】</span>。<span class="purple b">【中毒】</span>属于异常状态，需要用对应的药剂进行处理。幸好你随身携带了解毒剂。点击<span class="yellow b">【解毒剂】</span>对应的按钮以使用之。<br>除了解毒剂以外，其他异常状态也有对应的药剂，实战时可以捡到，也可以在商店中买到。”<br>',
		'object' => 'itemuse',
		'obj2' => Array(
			'itmk' => Array('Ca','Cp'),
		),
	...
	130 => Array(
		'tips' => '“除了有毒食物，也有其他的持有负面效果的道具存在，探索时需要谨慎。现在请再次点击<span class="yellow b">【探索】</span>按钮。”<br>',
		'object' => 'search',
		'obj2' => Array(
	...
	140 => Array(
		...
		'object' => 'any',
		'obj2' => Array(
			'meetnpc' => 91, 'meetsub' => 0,'active' => 0,'inf' => 'f','always_hit' => 1
		),
		'pulse' => '#z',
		'next' => 150
	),
	...
	170 => Array(
		'tips' => '“很好，现在你从受伤状态完全恢复了。<br>除了使用道具之外，消耗<span class="lime b">【技能点数】</span>或者<span class="lime b">【静养】</span>一定时间也可以解除异常状态。<br>敌人还在当前地点，让我们去还以颜色。点击<span class="yellow b">【探索】</span>”<br>',
		'object' => 'search',
		'obj2' => Array(
