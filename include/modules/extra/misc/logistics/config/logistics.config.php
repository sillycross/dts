...
namespace logistics
{
	...
	//售卖物品列表，每个array包含名称、类别、价格、文字介绍
	//类别1表示可使用道具（消耗品），2表示装饰品
	$logistics_shop_items = array(
		1 => array('切糕盒子',1,120,'使用后会随机获得一定量的切糕'),
		2 => array('闪光贴膜',1,233,'使用后可消耗切糕，使一张卡片变为闪烁'),
		3 => array('棱镜碎片',1,999,'使用后可消耗切糕，使一张卡片变为镜碎'),
		4 => array('天马能量饮料',1,777,'使用后可选择一张卡片完成充能'),
		5 => array('黄鸡玩偶',2,3000,'咕咕咕！'),
	);
