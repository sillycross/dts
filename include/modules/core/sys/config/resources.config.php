...
namespace sys
{
	...
	$gtinfo=array(0=>'常规局',1=>'<span class="clan">周三活动</span>',10=>'SOLO模式',11=>'二队模式',12=>'三队模式',13=>'四队模式',14=>'五队模式',15=>'<span class="yellow">伐木挑战</span>',16=>'<span class="green">解离模式</span>');
	...
	$dinfo = Array(
		...
		16 => '“……竟然一点有用的东西都不剩下了吗？！”，又是一个失望的声音。<br>死人是无法主宰自我的，一个又一个参战者经过你的尸体，搜刮走了所有有用的东西。你所有曾经在这个世界上留下的痕迹都被抹平了。<br>',
