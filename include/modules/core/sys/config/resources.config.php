...
namespace sys
{
	...
	$gtinfo=array(0=>'标准模式',1=>'<span class="clan">除错挑战</span>',2=>'<span class="orange">周五活动</span>',3=>'<span class="lime">宝石乱斗</span>',4=>'卡片模式',10=>'SOLO模式',11=>'二队模式',12=>'三队模式',13=>'四队模式',14=>'五队模式',15=>'<span class="yellow">伐木挑战</span>',16=>'<span class="green">解离模式</span>',17=>'教程模式');
