...
namespace sys
{
	...
	$gtinfo=array(0=>'标准模式',1=>'<font class="clan">除错挑战</font>',2=>'<font class="orange">周五活动</font>',3=>'<font class="lime">宝石乱斗</font>',4=>'卡片模式',10=>'SOLO模式',11=>'二队模式',12=>'三队模式',13=>'四队模式',14=>'五队模式',15=>'<font class="yellow">伐木挑战</font>',16=>'<font class="green">解离模式</font>',17=>'教程模式',18=>'<font class="clan">荣耀模式</font>');
