...
$mixinfo = array
	...
	array('class' => 'wf_pn', 'stuff' => array('红色方块','打火机','空白符卡'),'result' => array('火符「Agni Shine」','WF',77,'∞','uU'),),
	array('class' => 'wf_pn', 'stuff' => array('蓝色方块','水','空白符卡'),'result' => array('水符「Princess Undine」','WF',88,'∞','iI'),),
	array('class' => 'wf_pn', 'stuff' => array('绿色方块','治愈之叶','空白符卡'),'result' => array('木符「Sylphy Horn」','WF',77,'∞','wW'),),
	array('class' => 'wf_pn', 'stuff' => array('金色方块','电池','空白符卡'),'result' => array('金符「Metal Fatigue」','WF',88,'∞','eE'),),
	array('class' => 'wf_pn', 'stuff' => array('黄色方块','岩石','空白符卡'),'result' => array('土符「Lazy Trilithon」','WF',66,'∞','Nc'),),
	array('class' => 'wf_pn', 'stuff' => array('火符「Agni Shine」','水符「Princess Undine」','木符「Sylphy Horn」','金符「Metal Fatigue」','土符「Lazy Trilithon」'),'result' => array('火水木金土符『贤者之石』','WF',500,'∞','uipweN'),),
	array('class' => 'wf_pn', 'stuff' => array('红宝石方块','火符「Agni Shine」'),'result' => array('火符『Akiba Summer』','WF',220,'∞','uUf'),),
	array('class' => 'wf_pn', 'stuff' => array('蓝宝石方块','水符「Princess Undine」'),'result' => array('水符『Jerry Fish Princess』','WF',88,'∞','riI'),),
	array('class' => 'wf_pn', 'stuff' => array('绿宝石方块','木符「Sylphy Horn」'),'result' => array('木符『Green Storm』','WF',190,'∞','wWtN'),),
	array('class' => 'wf_pn', 'stuff' => array('银色方块','水晶方块','金符「Metal Fatigue」'),'result' => array('金符『Silver Dragon』','WF',200,'∞','eEn'),),
	array('class' => 'wf_pn', 'stuff' => array('黑色方块','白色方块','土符「Lazy Trilithon」'),'result' => array('土符『Trilithon Shake』','WF',240,'∞','dc'),),
	array('class' => 'wf_pn', 'stuff' => array('火符『Akiba Summer』','水符『Jerry Fish Princess』','木符『Green Storm』','金符『Silver Dragon』','土符『Trilithon Shake』'),'result' => array('火水木金土符『贤者之石』-上级','WF',5000,'∞','uipwenNc'),),
	array('class' => 'wf_pn', 'stuff' => array('火水木金土符『贤者之石』','《魔女的魔导书》','《东方灵异传》'),'result' => array('火水木金土符『贤者之石』-上级','WF',5000,'∞','uipweN'),),
  ...
  array('class' => 'ocg', 'stuff' => array('「电子终结龙」 ★10','「电子终结龙」 ★10','「电子终结龙」 ★10'),'result' => array('「电子天龙头」 ★10','WC10',1200,'∞','ZNnrc'),),
	...
	array('class' => 'ocg', 'stuff' => array('甲化铠骨骼 ★6 -仮','☆六星认证☆'),'result' => array('甲化铠骨骼 ★6','DF06',250,160,'GD^001'),),
