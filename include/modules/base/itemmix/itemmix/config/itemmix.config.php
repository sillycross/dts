...
$mixinfo = array
	...
	array('class' => 'wk', 'stuff' => array('曾经的荣光-深蓝','蓝宝石方块'),'result' => array('奥义『冰华⑨咲』','WKF',299,'∞','crkN^ac'),),
	array('class' => 'wk', 'stuff' => array('奥义『冰华⑨咲』','《曾伽·宗博尔特自传》'),'result' => array('奥义『超⑨武神霸斩』','WKF',999,'∞','rkNaH^ac'),),
	//array('class' => 'wk', 'stuff' => array('飞龙刀【银】','悲叹之种','《曾伽·宗博尔特自传》'),'result' => array('氷刃【雪月花】','WK',1500,'∞','Znrik'),),
	
	array('class' => 'wk', 'stuff' => array('原型武器K','食堂的盒饭'),'result' => array('骨刃','WK',130,80,'^ac',),),
	array('class' => 'wk', 'stuff' => array('骨刃','水群之枪','丢人之摸','雪碧之罐','捧杀之钩'),'result' => array('轰剑【虎眼】','WK',360,200,'^ac',),),
	array('class' => 'wk', 'stuff' => array('轰剑【虎眼】','磨刀石','沉默磨刀石','传说的白磨刀石'),'result' => array('吼剑【地咬】','WK',840,120,'N^ac',),),
	array('class' => 'wk', 'stuff' => array('轰剑【虎眼】','磨刀石','沉默磨刀石','赛路尔之磨刀石'),'result' => array('吼剑【地咬】','WK',840,120,'N^ac',),),
	...
	array('class' => 'wd', 'stuff' => array('伏特加','一杯八分满的啤酒'),'result' => array('深水炸弹『depth charge』','WD',133,45,'d^ac'),),
	array('class' => 'wd', 'stuff' => array('深水炸弹『depth charge』','火药'),'result' => array('莫洛托夫鸡尾酒','WD',150,40,'ud^ac'),),
	array('class' => 'wd', 'stuff' => array('咖啡酒','百利甜','伏特加'),'result' => array('奇怪的三色饮料','HB^ac',133,2),),
	array('class' => 'wd', 'stuff' => array('奇怪的三色饮料','打火机','杯子'),'result' => array('B-52轰炸机','WD',160,35,'ud^ac'),),
	array('class' => 'wd', 'stuff' => array('密封的酒瓶','★阔剑地雷★','莫洛托夫鸡尾酒'),'result' => array('烈焰风暴','WD',92,300,'urdZ^ac'),),
	array('class' => 'wd', 'stuff' => array('密封的酒瓶','★阔剑地雷★','B-52轰炸机'),'result' => array('烈焰风暴','WD',92,250,'urdZ^ac'),),
	array('class' => 'wd', 'stuff' => array('伏特加','柠檬汁','红石榴汁'),'result' => array('【烈焰红唇】','HB',233,2),),
	array('class' => 'wd', 'stuff' => array('【烈焰红唇】','密封的酒瓶'),'result' => array('★血腥玛丽★Bloody Mary','WD',310,150,'dw^ac'),),
	array('class' => 'wd', 'stuff' => array('伏特加','牛肉汤','バカ⑨制冰块'),'result' => array('【燃烧的鸡尾酒】','HB',233,2),),
	array('class' => 'wd', 'stuff' => array('【燃烧的鸡尾酒】','密封的酒瓶'),'result' => array('★公牛子弹★Bull Shot','WD',210,300,'dr^ac'),),
	array('class' => 'wd', 'stuff' => array('★血腥玛丽★Bloody Mary','★公牛子弹★Bull Shot','密封的酒瓶'),'result' => array('★血腥公牛★Bloody Bull','WD',520,450,'dwry^ac'),),
	...
	array('class' => 'wd', 'stuff' => array('寒冰炸弹','奥术飞弹','烈焰风暴'),'result' => array('★BIUBIUBIU★','WD',600,400,'ZnyNdr^ac'),),
