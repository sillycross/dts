...
$mixinfo = array
	...
	//直死属性尚未实现 先将就用
	array('class' => 'hidden', 'stuff' => array('沾满绿锈的铜刀','『祝福宝石』'),'result' => array('妖刀【飞叶】','WK',5,2,'rp'),),
	array('class' => 'hidden', 'stuff' => array('妖刀【飞叶】','★全地图唯一的野生高伤阔剑地雷★'),'result' => array('影刀【秋岚】','WK',522,522,'Zrpd'),),
	array('class' => 'wk', 'stuff' => array('■DarthNote■','☆七星认证☆'),'result' => array('夜刀【月影】','WK',130,170,'p'),),
	array('class' => 'wk', 'stuff' => array('夜刀【月影】','悲叹之种'),'result' => array('疾风刀【里月影】','WK',570,240,'rd'),),
	array('class' => 'wk', 'stuff' => array('夜刀【月影】','《魔女的魔导书》'),'result' => array('破岩刀【焰】','WK',660,120,'Hud'),),
	array('class' => 'wk', 'stuff' => array('破岩刀【焰】','☆爆裂模式☆'),'result' => array('碎光之晓刀','WK',2400,14,'Hd'),),
	...
	array('class' => 'wg', 'stuff' => array('★阔剑地雷★','电磁发射装置'),'result' => array('【定向阔剑发射器】','WG',810,3,'dNo'),),
	...
	array('class' => 'pokemon', 'stuff' => array('《小黄的精灵球》','《小黄的收服特训》'),'result' => array('《小黄的超级球》','WC',233,'∞','Zr'),),
	array('class' => 'pokemon', 'stuff' => array('《小黄的精灵球》','《小黄的收服特训》','露琪亚之羽'),'result' => array('《小黄的超级球》','WC',233,'∞','Zri'),),
	array('class' => 'pokemon', 'stuff' => array('《小黄的精灵球》','《小黄的收服特训》','凤凰之羽'),'result' => array('《小黄的超级球》','WC',233,'∞','Zru'),),
	array('class' => 'pokemon', 'stuff' => array('《小黄的精灵球》','《小黄的收服特训》','露琪亚之羽','凤凰之羽'),'result' => array('《小黄的超级球》','WC',233,'∞','Zriu'),),
	array('class' => 'pokemon', 'stuff' => array('《小黄的超级球》','《小黄的常磐之力》','《小黄的收服特训》'),'result' => array('《小黄的大师球》','WC',386,'∞','Zrd'),),
