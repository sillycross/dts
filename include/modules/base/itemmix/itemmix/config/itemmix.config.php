...
$mixinfo = array
	...
	array('class' => 'wf', 'stuff' => array('霊符「梦想封印」','《东方灵异传》','☆★☆大打击☆★☆'),'result' => array('神技「八方龍殺陣」','WFD',320,'∞','crd'),),
	array('class' => 'wf', 'stuff' => array('神技「八方鬼縛陣」','原型武器F','原型武器D','触手的力量'),'result' => array('神霊「夢想封印　瞬」','WFD',1500,'∞','cnrdZ'),),
	array('class' => 'wf', 'stuff' => array('神技「八方龍殺陣」','原型武器F','原型武器D','CAVE社特典CD『胎慟』'),'result' => array('「梦想天生」','WFD',6000,'∞','cnrdZ'),),
  ...
  array('class' => 'ocg', 'stuff' => array('「隼骑士」-仮','☆四星认证☆'),'result' => array('「隼骑士」 ★3','WC03',100,'∞','rj'),),
	...
	array('class' => 'ocg', 'stuff' => array('「VW-强击虎」','「XYZ-神龙炮」'),'result' => array('「VWXYZ-神龙强击炮」','WC08',320,'∞','puiewy'),),
	array('class' => 'ocg', 'stuff' => array('「V-喷气虎」','「W-弹射飞翼」','「X-首领加农」','「Y-龙头」','「Z-金属履带」'),'result' => array('「VWXYZ-神龙强击炮」','WC08',450,'∞','puiewy'),),
	...
	array('class' => 'ocg', 'stuff' => array('「真紅眼黑龍」-仮','☆七星认证☆'),'result' => array('「真紅眼黑龍」','WC07',240,'∞','u'),),
	...
	array('class' => 'ocg', 'stuff' => array('「左轮手枪龙」-仮','☆七星认证☆'),'result' => array('「左轮手枪龙」','WC07',260,'∞','r'),),
	array('class' => 'ocg', 'stuff' => array('「破龙剑士」-仮','☆七星认证☆'),'result' => array('「破龙剑士」','WC07',260,'∞','cC'),),
	array('class' => 'ocg', 'stuff' => array('「黑魔术师」-仮','☆七星认证☆'),'result' => array('「黑魔术师」','WC07',250,'∞','cC'),),
	array('class' => 'ocg', 'stuff' => array('「黑魔术师」','「破龙剑士」'),'result' => array('「超魔导剑士-黑暗帕拉丁」','WC08',300,'∞','crdZy'),),
